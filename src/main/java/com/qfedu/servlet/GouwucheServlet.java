	...
	*/
	...
	protected void select2(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("".equalsIgnoreCase(name)){
			...
			request.getRequestDispatcher("GouwucheServlet?op=insert").forward(request, response);
		}
	...
	protected void delete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(flag>0){
		request.getRequestDispatcher("GouwucheServlet?op=select").forward(request, response);
		}
