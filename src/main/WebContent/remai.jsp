...
<div id="showShopBox">
    <div class="showShop">
        ...
        <%
							List<OrderCartitem> list =(List<OrderCartitem>)request.getAttribute("list");
							for(OrderCartitem l : list){
								
				%>    
    
        <dl>
            <dt><a href="details.html"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><img src="./images/<%=l.getO2() %>" /></a></dt>
            <dd class="showShop_firstDd"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><%=l.getO1()%>系列</a></dd>
          
            <dd class="showShop_tiredDd"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><%=l.getPrices() %></a></dd>
        </dl>
