    ...
    <div id="allNav">
        ...
        <div class="ejcdDiv">
            ...
            <div class="secondNavOne secondNavThree">
                ...
                <dl>
                    <dt><a href="baozhu.jsp">玫瑰宝珠</a></dt>
                    <dd><a href="#">玫瑰经典</a></dd>
                    <dd><a href="#">星座经典</a></dd>
                    <dd><a href="#">生辰石</a></dd>
                    <dd><a href="#">恒久经典</a></dd>
                ...
                <dl>
                    <dt><a href="shiping.jsp">玫瑰饰品</a> </dt>
                    <dd><a href="#">幸运精灵</a></dd>
                    <dd><a href="#">时光之吻</a></dd>
                    <dd><a href="#">爱之赞礼</a></dd>
                    <dd><a href="#">全心全意</a></dd>
...
<div id="showShopBox">
    <div class="showShop">
        ...
        <%
							...
							for(Product l : list){
								if(3==l.getCategory() && !"小".equalsIgnoreCase(l.getDescr()) && !"大".equalsIgnoreCase(l.getDescr())){
				%>    
    
        <dl>
            <dt><a href="details.html"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><img src="./images/<%=l.getImg1() %>" /></a></dt>
            <dd class="showShop_firstDd"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><%=l.getCate().getCname() %> - <%=l.getP6() %>系列</a></dd>
            <dd class="showShop_secondDd"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><%=l.getDescr() %></a></dd>
            <dd class="showShop_tiredDd"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><%=l.getPrice() %></a></dd>
        </dl>
