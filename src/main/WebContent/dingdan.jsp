...
<div class="logo-container">
	<a href="IndexServlet" class="logo_nbtn">
	...
	<div class="shoppingCart_center">
            <table Cellspacing="0">
                <tbody>
                   <tr class="shoppingCart_center_first_tr">
                        <td class="shoppingCart_center_td1">编号</td>

                        <td class="shoppingCart_center_td3">商品名称</td>
                        <td class="shoppingCart_center_td4">价格</td>
                        <td class="shoppingCart_center_td4">数量</td>
						<td class="shoppingCart_center_td4">订单号</td>
		...
		%>
                          ...
                          <tr class="shoppingCart_center_second_tr">
                             ...
                             <td class="shoppingCart_center_td3"><img src="./images/<%=l.getO2() %>"><span><%=l.getO1() %>-经典-朱砂-19支</span></td>
                             <td class="shoppingCart_center_td4"><%=l.getPrices()%></td>
                             <td class="shoppingCart_center_td4"><%=l.getO3()%></td>
                           	  <td class="shoppingCart_center_td4"><%=l.getTime()%></td>
                           	  <td class="shoppingCart_center_td4"><%=l.getStatus()%></td>
                         </tr>
             <% shanchu=l.getName(); %>
                                <% 
		...
		i++;}%> 
            ...
            <a style="margin-left:800px;font-size: 20px" href="#">点我支付</a>
