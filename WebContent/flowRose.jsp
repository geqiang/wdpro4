...
<div id="showShopBox">
    ...
    <%
							...
							for(Product l : list){
								if(1==l.getCategory()  && !"小".equalsIgnoreCase(l.getDescr()) && !"大".equalsIgnoreCase(l.getDescr())){
				%>
    
        <dl>
            <dt><a href="details.html"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><img src="./images/<%=l.getImg1() %>" /></a></dt>
            <dd class="showShop_firstDd"><a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid() %>"><%=l.getPname()%> - <%=l.getP6() %>系列</a></dd>
