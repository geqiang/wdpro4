	...
	<div id="#toolBox">
		<div class="tool">
			...
			<div class="toolRight">
				...
				<div class="addAndCut">
					<input type="button" class="addInt" value="∧" /> <input
						type="button" class="cut" value="∨" />
				</div>
			</div>
			<p>-</p>
			<div class="toolRight">
	...
	<div id="showShopBox">
		<div class="showShop">
			...
			<%
				...
				for (Product l : list) {
					if ((4 == l.getCategory() || 3 == l.getCategory()) && !"小".equalsIgnoreCase(l.getDescr())
				...
				<dt>
					<a href="details.html"><a
						href="ShangpingServlet?op=xiangqing&id=<%=l.getPid()%>"><img
							src="./images/<%=l.getImg1()%>" /></a>
				</dt>
				<dd class="showShop_firstDd">
					<a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid()%>"><%=l.getCate().getCname()%> - <%=l.getP6()%>系列</a>
				</dd>
				<dd class="showShop_secondDd">
					<a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid()%>"><%=l.getDescr()%></a>
				</dd>
				<dd class="showShop_tiredDd">
					<a href="ShangpingServlet?op=xiangqing&id=<%=l.getPid()%>"><%=l.getPrice()%></a>
				</dd>
			</dl>
