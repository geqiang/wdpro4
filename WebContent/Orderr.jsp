...
<%@page import="com.qfedu.Dao.Impl.CartitemImpl"%>
<%@page import="com.qfedu.Dao.Icartitem"%>
...
<div class="logo-container">
	<a href="index.jsp" class="logo_nbtn">
...
<!--头部end-->
	...
	<div class="container">
		...
		<div class="shopping">
			...
			<div class="order-left">
				...
				<table width="100%" height="150" border="0" cellspacing="0">
						...
						<tr>
							...
							<td align="left" class="cor-2">
								<input id="mobile" class="contactname_input" type="text" maxlength="60" name="dizhi"/>
							</td>
						</tr>
						<tr>
							<td align="left" ><span class="red">*</span>邮编：</td>
							<td align="left" class="cor-2">
								<input id="mobile" class="contactname_input" type="text" maxlength="11" name="youbian"/>
							</td>
						</tr>
				</table>
			...
			<div class="order-nav"><a href="#">保存信息</a></div>
	...
	<div class="shoppingCart_center">
		...
		%>
                          ...
                          <tr class="shoppingCart_center_second_tr">
                             ...
                             <td class="shoppingCart_center_td5"><span>-</span><input value=<%=l.getCount() %>><span>+</span></td>
                             <td class="shoppingCart_center_td6"><a href="javascript:if(confirm('确实要清空吗?'))location='BuyingServlet?op=delete&id=<%=l.getCaid() %>'">删除</a></td>
                         </tr>
             <% shanchu=l.getName(); %>
                                <% 
		...
		i++;}%> 
            ...
            </table>    <p class="allMoney"><span>元</span><i><%=num %></i><span>合计：</span></p>
          
            <input type="submit" value="提交订单" style=" font-size:25px; align:center;text-align: right;"> </a>
           <input type="hidden" class="username" name="user" value="<%=shanchu %>"> 
       <a href ="javascript:if(confirm('确实要清空吗?'))location='BuyingServlet?op=delete2&user=<%=shanchu %>'" style=" font-size:25px;margin-left:20px">清空订单</a>    
